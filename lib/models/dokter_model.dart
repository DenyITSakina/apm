...
class DokterModel {
  ...
  final int? kuotaNonJkn;
  final int libur;
  final int? terpakaiKapasitaspasien;
  final int? sisaKoutaKapasitaspasien;
  final int? kapasitasJkn;
  ...
  DokterModel({
    ...
    this.kuotaNonJkn,
    required this.libur,
    this.terpakaiKapasitaspasien,
    this.sisaKoutaKapasitaspasien,
    this.kapasitasJkn,
  });
  ...
  factory DokterModel.fromJson(Map<String, dynamic> json) {
    return DokterModel(
      ...
      kapasitasPasien:
          int.tryParse(json['kapasitaspasien']?.toString() ?? '0') ?? 0,
      kuotaNonJkn: json['kuotanonjkn'] != null
          ? int.tryParse(json['kuotanonjkn'].toString())
          : null,
      libur: int.tryParse(json['libur']?.toString() ?? '0') ?? 0,
      terpakaiKapasitaspasien: json['terpakai_kapasitaspasien'] != null
          ? int.tryParse(json['terpakai_kapasitaspasien'].toString())
          : null,
      sisaKoutaKapasitaspasien: json['sisa_kouta_kapasitaspasien'] != null
          ? int.tryParse(json['sisa_kouta_kapasitaspasien'].toString())
          : null,
      kapasitasJkn: json['kapasitas_jkn'] != null
          ? int.tryParse(json['kapasitas_jkn'].toString())
          : null,
    );
  }
